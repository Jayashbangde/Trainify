    ...
    <div className='footer-container'>
      ...
      <div className='foot-link'>
       ...
       <Link to='https://www.facebook.com/'> <i className="fa-brands fa-facebook"></i></Link>
        ...
        <p>Develop by Jayash Bangde<br/>@ 2025</p>  
        </div>
      </div>
      <div className='foot-link'>
        <h3>CONTACT US</h3><br/>
        <p><Link to={"callto:7887595097"}><i className="fa-solid fa-phone"></i> +91 7887595097</Link></p><br/>
        <p><Link to={"mailto:jayashbangde@gmail.com"}><i className="fa-solid fa-envelope"></i> jayashbangde@gmail.com</Link></p><br/>
      </div>
